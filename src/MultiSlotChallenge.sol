...
contract MultiSlotChallenge {
    ...
    event ChallengeEnded(
        uint256 indexed challengeId, address indexed player, bool paidOut, uint256 payout, string reason
    );
    ...
    constructor(address _usdc, address _feeRecipient, uint256 _fee, uint256 _reward, uint256 _duration) {
    ...
    */
    ...
    function startChallenge() external returns (uint256 challengeId) {
        ...
        require(challengesStarted[msg.sender] < maxChallengesPerWallet, "max challenges reached");
        ...
        */
        ...
        require(remaining >= MIN_REMAINING_BALANCE, "must have at least $1 remaining");
        ...
        */
        ...
        emit ChallengeStarted(challengeId, msg.sender, remaining, c.startTime, fee, reward);
    }
    ...
    */
    function finalizeIfFailed(uint256 challengeId) external {
        ...
        require(currentBalance < c.startBalanceAfterFee, "challenge not failed");
